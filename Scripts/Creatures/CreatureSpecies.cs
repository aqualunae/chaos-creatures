...
public class CreatureSpecies : ScriptableObject
{
    ...
    [Header("Features - Sort from most common to rarest."), Tooltip("The possible shapes of the species.")]
    ...
    [Header("Options - Sort from most common to rarest."), Tooltip("The possible colors and patterns of the species.")]
    ...
    {
        get => options.accentColors[0].color;
    }
    ...
    /// <summary>
    /// Gets the genetic odds for an offspring of two creatures of this species.
    /// </summary>
    public GeneticOdds GetGeneticOdds(SaveableCreature firstParent, SaveableCreature secondParent)
    {
        if (!firstParent.species.Equals(species) || !secondParent.species.Equals(species))
        {
            Debug.Log("Wrong creature species");
            return null;
        }

        GeneticOdds defaultOdds = GetGeneticOdds();
